...
public class GetUserByEmailQueryHandler : IRequestHandler<GetUserByEmailQuery, Result<DTOs.UserDto>>
{
    ...
    public async Task<Result<DTOs.UserDto>> Handle(GetUserByEmailQuery request, CancellationToken cancellationToken)
    {
